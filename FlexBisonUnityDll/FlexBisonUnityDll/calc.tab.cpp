...
static const char *const yytname[] =
{
  ...
  "OP", "CP", "EOL", "$accept", "calclist", "exp", "factor", "term", YY_NULL
};
#endif
...
/* Line 1792 of yacc.c  */
#line 38 "calc.y"
    {std::string out = std::to_string((yyvsp[(2) - (3)]));
BisonOut(out);}
    break;
